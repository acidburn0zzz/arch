...
# Packages
sudo pacman -S arc-gtk-theme biber compton feh firefox git light neovim noto-fonts-cjk perl-authen-sasl pulsemixer reflector scrot slock texlive-bibtexextra texlive-core ttf-dejavu ufw xdg-utils xorg-server xorg-xinit xorg-xrandr xorg-xsetroot xsel # nvidia
...
cd .. && rm -fr yay
yay -S dropbox flat-remix-git nerd-fonts-ubuntu-mono xbanish
