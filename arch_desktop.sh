...
# Packages
sudo pacman -S arc-gtk-theme biber compton evince feh firefox git htop libreoffice-fresh light neovim networkmanager noto-fonts-cjk numlockx pulseaudio pulsemixer scrot shellcheck texlive-bibtexextra texlive-core ttf-dejavu ufw xorg-server xorg-xsetroot xorg-xinit # nvidia
