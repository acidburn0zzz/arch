...
# Packages
sudo pacman -S arc-gtk-theme biber compton firefox git hsetroot libexif libreoffice-fresh light neovim networkmanager noto-fonts-cjk numlockx perl-authen-sasl pulsemixer scrot shellcheck texlive-bibtexextra texlive-core ttf-dejavu ufw xorg-server xorg-xsetroot xorg-xinit xsel # nvidia
