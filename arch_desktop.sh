...
# Packages
sudo pacman -S arc-gtk-theme biber compton feh firefox git libreoffice-fresh light neovim networkmanager newsboat noto-fonts-cjk numlockx pulsemixer scrot texlive-bibtexextra texlive-core ttf-dejavu ufw xdg-utils xorg-server xorg-xsetroot xorg-xinit xsel zathura-pdf-poppler # nvidia
