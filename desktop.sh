...
sudo pacman -S arc-gtk-theme dash fakeroot firefox gcc git herbstluftwm light make neovim noto-fonts-cjk pkgconf pulsemixer python-neovim sxkhd tmux ttf-dejavu xorg-server xorg-xinit xsel yarn
