...
sudo pacman -S arc-gtk-theme biber compton feh firefox git light neovim noto-fonts-cjk numlockx pulsemixer scrot slock texlive-bibtexextra tmux ttf-dejavu ufw unclutter xorg-server xorg-xinit xsel zathura-pdf-poppler # nvidia
