...
sudo pacman -S arc-gtk-theme biber cinnamon ctags dash firefox fzf git nemo-fileroller neovim noto-fonts-cjk scrot shellcheck shfmt texlive-bibtexextra tmux ttf-dejavu ufw unclutter xorg-server xorg-xinit xsel yarn # nvidia
