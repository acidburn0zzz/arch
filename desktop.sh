...
# PACKAGES
sudo pacman -S arc-gtk-theme dash fakeroot firefox gcc git herbstluftwm light make neovim noto-fonts-cjk pulsemixer python-neovim rofi sx tmux ttf-dejavu xorg-server xsel yarn
