...
sudo pacman -S arc-gtk-theme biber ctags dash dunst firefox fzf git hsetroot light neovim newsboat noto-fonts-cjk pulsemixer scrot slock shellcheck texlive-bibtexextra tmux ttf-dejavu ufw unclutter xcompmgr xorg-server xorg-xinit xorg-xsetroot xsel yarn # nvidia
