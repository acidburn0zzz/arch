...
sudo pacman -S arc-gtk-theme dash dunst firefox fzf git light neovim pulsemixer slock tmux ttf-dejavu ufw unclutter xcompmgr xorg-server xorg-xinit xsel yarn
