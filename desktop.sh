...
# PACKAGES
sudo pacman -S arc-gtk-theme dash dmenu fakeroot firefox gcc herbstluftwm light make neovim pulsemixer python-pynvim sx sxhkd tmux ttf-dejavu xorg-server xsel yarn
