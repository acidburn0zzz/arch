...
sudo pacman -S arc-gtk-theme compton ctags dash firefox fzf git light neovim nodejs noto-fonts-cjk numlockx pulsemixer slock tmux ttf-dejavu ufw unclutter xorg-server xorg-xinit xorg-xset xorg-xsetroot xsel yarn
# biber feh mpv nvidia perl-authen-sasl scrot shellcheck shfmt texlive-bibtexextra youtube-dl zathura-pdf-poppler
